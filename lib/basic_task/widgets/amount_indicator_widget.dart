...
class AmountIndicatorWidget extends StatelessWidget {
  const AmountIndicatorWidget({required this.currentValue,required this.maxValue, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: Text('$currentValue / $maxValue', style: TextStyle(color: Colors.white, fontSize: 9.sp),),
      ),
    );
  }
}
